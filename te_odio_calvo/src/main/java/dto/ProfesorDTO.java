...
public class ProfesorDTO {
        ...
        try {
            ...
            while (resultSet.next()){
                System.out.println(resultSet.getString(SchemaDB.COL_NAME)+" "+
                        ...
                        resultSet.getString(SchemaDB.COL_SALARIO)+" ");
            }
            resultSet.close();
            statement.close();
    ...
    public boolean eliminarProfesorListado(String dni){
        return
        listaProfesores.removeIf(profesorEliminar -> profesorEliminar.getDni().equalsIgnoreCase(dni));

    }

    public void mostrarLista(){
        for (Profesor listaProfesores : listaProfesores){
    ...
    public void exportarDatosFicheroCSV(String path){
        ...
        try {
            ...
            for (Profesor listaProfesores : listaProfesores){
                printWriter.println("DNI:"+listaProfesores.getDni()+
                        "Nombre"+listaProfesores.getNombre()+
