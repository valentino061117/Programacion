            ...
            switch (opcion){
                ...
                case 2:
                    ...
                    if (tipo == 1){
                        ...
                        profesorDTO.agregarProfesorTemporal(new ProfesorExterno(nombre,dni,salario,numeroHoras,precioHoras));
                        System.out.println("Profesor externo agregado correctamente");
                    }
                    break;
                case 3:
                    System.out.println("Dni para eliminar:");
                    String eliminarDni = scanner.next();
                    if (profesorDTO.eliminarProfesorListado(eliminarDni)){
                        System.out.println("Eliminado con exito");
                    }else {
                        System.out.println("No se encontro al profesor con ese dni");
                    }
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    profesorDTO.exportarDatosFicheroCSV("src/main/java/resources/profesor.CSV");
                    break;
                case 6:
                    profesorDTO.exportarDatosFicherosOBJ("src/main/java/resources/profesor.obj");
                    break;
                case 7:
